<div class="row">
	<div class="col-md-12 col-sm-12 col-xs-12">
		<div class="x_panel tile alert alert-info">
			<div class="x_content">
				<div class="x_panel">
              		<div class="x_title">
              		...
              		<div class="x_content">
						...
						<table class="table table-striped jambo_table bulk_action">
	                    		<thead>
	                      			<tr class="headings">
			                            <th class="column-title">Judul Kajian</th>
			                            <th class="column-title">Kota</th>
										<th class="column-title">Tanggal Acara</th>
	                    		...
	                    		<tbody>
	                      			<tr class="even pointer">
			                            <td class=" ">Tabligh Akbar</td>
			                            <td class=" ">Jakarta Selatab</td>
										<td class=" ">2 Juli 2020</td>
			                            <td class=" ">
